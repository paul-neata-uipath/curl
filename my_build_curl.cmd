...
cmake .. ^
    ...
    -DCMAKE_C_FLAGS="/DMACHINE=x86 /DP_ARCH=x86" ^
    -DCMAKE_RC_FLAGS="/DMACHINE=x86 /DP_ARCH=x86" ^
...
cmake .. ^
    ...
    -DCURL_STATICLIB=OFF ^
    -DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded ^
    -DCMAKE_C_FLAGS="/DMACHINE=x64 /DP_ARCH=ia64" ^
    -DCMAKE_RC_FLAGS="/DMACHINE=x64 /DP_ARCH=ia64" ^
...
copy %BUILD_DIR_X86%\lib\Release\libcurl_x86.lib %COMPILED_FOLDER%\        || ( call :last_message "Cannot copy x86 LIB" & exit /b 13 )
...
copy %BUILD_DIR_X64%\lib\Release\libcurl_x64.lib %COMPILED_FOLDER%\        || ( call :last_message "Cannot copy x64 LIB" & exit /b 16 )
